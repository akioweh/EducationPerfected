...
(async () => {
    const DIR = {
        email: 45900@students.lindenps.org,  // replace YOUR EMAIL with your email for auto login (keep everything else the same)
        password: 12345,  // replace YOUR PASSWORD with your password for auto login
